...
if args.train:
    #total size of dataset: 280368
    shard_size = sizeOfShard(args.container, args.shard) # 56073
    slice_size = shard_size // args.slices # one slice == 56073
    ...
    for sl in range(args.slices):
        ...
        ) # hash of the points not contained in the unlearning requests
